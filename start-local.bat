...
echo [2/3] Iniciando OrderGenerator (API + Swagger) - http://localhost:5000
start "Generator" cmd /k "cd Backend\OrderManager\OrderGenerator && echo Generator: http://localhost:5000 && dotnet run"
